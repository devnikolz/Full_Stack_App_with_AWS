...
const Update = ({ oldLink, token }) => {
    ...
    const { title, description, url, categories, loadedCategories, success, error, type, medium } = state;
    ...
    const handleSubmit = async e => {
        ...
        try {
            const response = await axios.put(
                dynamicUpdateUrl,
                { title, description, url, categories, type, medium },
                {
                    headers: {
    ...
    const submitLinkForm = () => (
        <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={handleDescriptionChange} value={description} />
            </div>
            <div className="form-group">
